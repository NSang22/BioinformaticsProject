...
# Load metadata
coldata <- readr::read_tsv(file.path(data_dir, "metadata_SRP192714.tsv"))
...
# Replace 'group' with your actual group/condition column name, e.g. 'disease'
dds <- DESeqDataSetFromMatrix(countData = cts,
                              colData = coldata,
                              design = ~ disease) # <-- change 'disease' to your column

dds <- DESeq(dds)
vsd <- vst(dds, blind=FALSE)
plotPCA(vsd, intgroup="disease") # <-- change 'disease' to your column
```
