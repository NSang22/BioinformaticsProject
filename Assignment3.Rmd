...
```{r}
```{r pam-clustering, cache=TRUE, cache.lazy=FALSE}
...
<!-- pam_summary <- as.data.frame(pam_summary)   # ensure it's a standard data frame -->
...
After running PAM for k = 2 – 8 across the 5 000 most variable genes, k = 2 yielding the highest average silhouette (≈ 0.10).
