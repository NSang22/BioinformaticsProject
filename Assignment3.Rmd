...
# Section 1
```{r "Load Data", dependson="Install Packages", message=FALSE, eval = TRUE, cache=FALSE}
...
# Section 2a
```{r "Select Top Genes", dependson="Load Data", eval = TRUE, cache=FALSE}
...
```{r "hclust run", dependson="Select Top Genes", cache=FALSE}
...
### Heat Map
```{r "hclust heatmap", dependson="hclust run", cache=FALSE}
